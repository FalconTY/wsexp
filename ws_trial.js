...
var expblock=new buildblock(version2);
...
{	this.sl.push({stimulus: stmlist[i].style,  data: { correct_response:stmlist[i].cresp, item_id:stmlist[i].item_id, block_id:blockid}});
	...
	this.fixation = {
      ...
      trial_duration: function(){
        return jsPsych.randomization.sampleWithoutReplacement([200], 1)[0];
      },
...
//	this.allsegments.push(this.judgment1,this.judgment2);
 ...
 //var sentence1=new sentence();
   ...
   var block_practice={
    ...
    var debrief_block = {
      type: "html-keyboard-response",
      stimulus: "Hi, the main task of the experiment is finished. <br><br>As you might be aware. This experiment attempts to investigate whether distorting word presentation may affect visual word recognition. Thank you again for your participation.<br><br><b>However, there is one more favour to ask: save the data file and send it to me. </b><br>Ideally, in the next page a pop-up data file will turn up to be downloaded. In this case, just download the file and send it to (details in next page bottom). If the file does not show up,  you will see the data of your peformance shown in the next page. Please then read the information (at the bottom of the next page) provided about manually saving the data (actually very easy to do) and please send it to me.<br><br>I'm sorry to bother you with this but currently this website does not allow automatically sending data to the server. <br><br>Thank you so much!<br><br>If you understand what to do, press any key to continue to the next page.",
     };
...
function datasave(){
	...
	download(expblock.blockname+"_"+subname+".csv", ResText);
